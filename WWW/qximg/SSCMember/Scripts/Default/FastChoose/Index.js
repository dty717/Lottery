	...
	function arrayInclude(arr ,item){
		...
		return false
				...
				function render(){
					ini();
					var ruLe
					pData=makeStruct("x","x","x","x","x",ruLe);					
					var rules=[];
					
					var p1=document.getElementById("__dingwei_chu");
					var p2=document.getElementById("__dingwei_qu");
						var f1=document.getElementById("__dingwei_1");
						var f2=document.getElementById("__dingwei_2");
						var f3=document.getElementById("__dingwei_3");
						var f4=document.getElementById("__dingwei_4");
						
						if(f1.value!=""||(f1.value!=undefined)){
							四字定参数1=toNum(f1.value.split(""));
						}
						if(f2.value!=""||(f2.value!=undefined)){
							四字定参数2=toNum(f2.value.split(""));
						}
						if(f3.value!=""||(f3.value!=undefined)){
							四字定参数3=toNum(f3.value.split(""));
						}
						if(f4.value!=""||(f4.value!=undefined)){
							四字定参数4=toNum(f4.value.split(""));
						}
					if(p2.checked){
						rules.push(四字定)
					}
					...
					var p3=document.getElementById("__peishu_chu");
					var p4=document.getElementById("__peishu_qu");
						var f31=document.getElementById("__peishu_1");
						var f32=document.getElementById("__peishu_2");
						var f33=document.getElementById("__peishu_3");
						var f34=document.getElementById("__peishu_4");
						
						if(f31.value!=""||(f31.value!=undefined)){
							四字现参数1=toNum(f31.value.split(""));
							
						}
						if(f32.value!=""||(f32.value!=undefined)){
							
							四字现参数2=toNum(f32.value.split(""));
						}
						if(f33.value!=""||(f33.value!=undefined)){
							
							四字现参数3=toNum(f33.value.split(""));
						}
						if(f34.value!=""||(f34.value!=undefined)){
							
							四字现参数4=toNum(f34.value.split(""));
						}
						
					
					var p32=document.getElementById("__peishu_chu2");
					var p42=document.getElementById("__peishu_qu2");
					if(p42.checked){
						if(!includeName(rules,四字现))
							rules.push(四字现)
					}
					if(p32.checked){
						if(!includeName(rules,四字现))
					...
					var p5=document.getElementById("__hefen_chu");
					var p6=document.getElementById("__hefen_qu");
					var flag1=false;
					var f7=document.getElementById("__hefenzhide_w_11");
					var f8=document.getElementById("__hefenzhide_w_12");
					var f9=document.getElementById("__hefenzhide_w_13");
					var f10=document.getElementById("__hefenzhide_w_14");
					var f11=document.getElementById("__hefenzhide_1");
					...
					if(f11.value!=""&&(f11.value!=undefined)){
						合分参数1=parseInt(f11.value);
					}else{
						flag1=false
					}
					if(flag1){
					...
					var flag2=false;
					var f12=document.getElementById("__hefenzhide_w_21");
					var f13=document.getElementById("__hefenzhide_w_22");
					var f14=document.getElementById("__hefenzhide_w_23");
					var f15=document.getElementById("__hefenzhide_w_24");
					var f16=document.getElementById("__hefenzhide_2");
					...
					if(f16.value!=""&&(f16.value!=undefined)){
						合分参数2=parseInt(f16.value);
					}else{
						flag2=false
					}
					if(flag2){
					...
					var flag3=false;
					var f17=document.getElementById("__hefenzhide_w_31");
					var f18=document.getElementById("__hefenzhide_w_32");
					var f19=document.getElementById("__hefenzhide_w_33");
					var f20=document.getElementById("__hefenzhide_w_34");
					var f21=document.getElementById("__hefenzhide_3");
					...
					if(f21.value!=""&&(f21.value!=undefined)){
						合分参数3=parseInt(f21.value);
					}else{
						flag3=false
					}
					if(flag3){
					...
					var flag4=false;
					var f22=document.getElementById("__hefenzhide_w_41");
					var f23=document.getElementById("__hefenzhide_w_42");
					var f24=document.getElementById("__hefenzhide_w_43");
					var f25=document.getElementById("__hefenzhide_w_44");
					var f26=document.getElementById("__hefenzhide_4");
					...
					if(f26.value!=""&&(f26.value!=undefined)){
						合分参数4=parseInt(f26.value);
					}else{
						flag4=false
					}
					if(flag4){
					...
					var f27=document.getElementById("__bdwhefen_1");
					var f28=document.getElementById("__bdwhefen_2");
					var f29=document.getElementById("__bdwhefen");
					
					if(f29.value!=undefined&&(f29.value!="")){
						if(f27.checked){
							两数合参数=parseInt(f29.value)
							rules.push(两数合)
						}
						if(f28.checked){
							三合数参数=parseInt(f29.value)
							rules.push(三合数)
						}
						
					}
					var f30=document.getElementById("__quandao");
					if(f30.value!=undefined&&(f30.value!="")){
						全转参数=toNum(f30.value.split(""))
						if(全转参数.length==1){
							含参数.push(全转参数[0])
						}
						else if(全转参数.length==2){
							二字现参数1=全转参数[0]
							二字现参数2=全转参数[1]	
						}else if(全转参数.length==3){
							三字现参数1=全转参数[0]
							三字现参数2=全转参数[1]	
							三字现参数3=全转参数[2]	
						}else if(全转参数.length==4){
							四字现参数1=全转参数[0]
							四字现参数2=全转参数[1]	
							四字现参数3=全转参数[2]	
							四字现参数4=全转参数[3]	
					...
					var f31=document.getElementById("__shangjiang");
					if(f31.value!=undefined&&(f31.value!="")){
						if(!rules.includes(含))
							rules.push(含)
						含参数=含参数.concat(toNum(f31.value.split("")));
					}

					var f32=document.getElementById("__paichu");
					if(f32.value!=undefined&&(f32.value!="")){
						排除参数=toNum(f32.value.split(""))
						rules.push(排除)
					}
					
					
					var f33=document.getElementById("__chu_2");
					var f34=document.getElementById("__qu_2");
					var f35=document.getElementById("__han_2");
					if(f35.value!=undefined&&(f35.value!="")){
						含参数=toNum(f35.value.split(""))
						if(f33.checked)
							rules.push(除含)
						if(f34.checked)
							rules.push(含)
					}					
					var f36=document.getElementById("__fushi_2");
					if(f36.value!=undefined&&(f36.value!="")){
						复式参数=toNum(f36.value.split(""))
						rules.push(复式)
					}
					
					var f37=document.getElementById("__chu_chong_1");
					if(f37.checked){
						rules.push(除双重)
						
					}
					var f38=document.getElementById("__qu_chong_1");
					if(f38.checked){
						rules.push(双重)
					}

					var f39=document.getElementById("__chu_chong_3");					
					if(f39.checked){
						rules.push(除三重)
						
					}
					var f40=document.getElementById("__qu_chong_3");
					if(f40.checked){
						rules.push(三重)
						
					}
					var f41=document.getElementById("__chu_xiongdi_1");					
					if(f41.checked){
						rules.push(除二兄弟)

					}
					var f42=document.getElementById("__qu_xiongdi_1");
					if(f42.checked){
						rules.push(二兄弟)
						
					}
					var f43=document.getElementById("__chu_xiongdi_2");					
					if(f43.checked){
						rules.push(除三兄弟)
						
					}
					var f44=document.getElementById("__qu_xiongdi_2");
					if(f44.checked){
						rules.push(三兄弟)
						
					}
					var f45=document.getElementById("__duishu_1");
					if(f45.value!=undefined&&(f45.value!="")){
						对数参数11=parseInt(f45.value[0]);
						对数参数12=parseInt(f45.value[1]);
					}
					var f46=document.getElementById("__duishu_2");
					if(f46.value!=undefined&&(f46.value!="")){
						对数参数21=parseInt(f46.value[0]);
						对数参数22=parseInt(f46.value[1]);
					}
					var f47=document.getElementById("__duishu_3");
					if(f47.value!=undefined&&(f47.value!="")){
						对数参数31=parseInt(f47.value[0]);
						对数参数32=parseInt(f47.value[1]);
					}
					var f48=document.getElementById("__chu_duishu");
					if(f48.checked)
						rules.push(除对数)
					var f49=document.getElementById("__qu_duishu");
					if(f49.checked)
						rules.push(对数)
					var f50=document.getElementById("__dan_chu");
					var f51=document.getElementById("__dan_qu");
					var f52=document.getElementById("__dan_1");
					var f53=document.getElementById("__dan_2");
					var f54=document.getElementById("__dan_3");
					var f55=document.getElementById("__dan_4");
					if(f52.checked){
						if(f50.checked){
							rules.push(除(单个))
						}
					...
					var f56=document.getElementById("__shuang_chu");
					var f57=document.getElementById("__shuang_qu");
					var f58=document.getElementById("__shuang_1");
					var f59=document.getElementById("__shuang_2");
					var f60=document.getElementById("__shuang_3");
					var f61=document.getElementById("__shuang_4");
					if(f58.checked){
						if(f56.checked){
							rules.push(除(双个))
						}
					...
					var f62=document.getElementById("__chu_chong_2");					
					if(f62.checked){
						rules.push(除双双重)

					}
					var f63=document.getElementById("__qu_chong_2");
					if(f63.checked){
						rules.push(双双重)
					}
					var f64=document.getElementById("__chu_chong_4");					
					if(f64.checked){
						rules.push(除(四重))

					}
					var f65=document.getElementById("__qu_chong_4");
					if(f65.checked){
						rules.push(四重)
					}
					var f66=document.getElementById("__chu_xiongdi_3");					
					if(f66.checked){
						rules.push(除四兄弟)

					}
					var f67=document.getElementById("__qu_xiongdi_3");
					if(f67.checked){
						rules.push(四兄弟)
					}
					var f68=document.getElementById("__zhifanwei_start");
					
					if(f68.value!=undefined&&(f68.value!="")){
						
						if(f27.checked){
							两数合小参数=parseInt(f68.value);
							rules.push(两数合小)
						}
						if(f28.checked){
							三数合小参数=parseInt(f68.value);
							rules.push(三数合小)	
						}
					}

					var f69=document.getElementById("__zhifanwei_end");
					if(f69.value!=undefined&&(f69.value!="")){
						if(f27.checked){
							两数合大参数=parseInt(f69.value);

							rules.push(两数合大)
						}
						if(f28.checked){
							三数合大参数=parseInt(f69.value);
							rules.push(三数合大)
						}
					}
...
///////
	function showTable(list1,list2,list3,list4){
		var tc=new Set();
		if(list2.size!=0){
			var str='<table cellspacing="0" cellpadding="0" class="showselectnumber" border="0" ;"=""><tbody><tr>';
			var tr=1;
    ...
    var __ss = {
	    ...
	    */
	    this.__selectnumber=callarr
	    this.__selectnumbertotal =callarr.length;
    ...
    exports.viewmodel = function () {
        ...
        this.submit = function () {
		    ...
		    var d = dialog({
                    ...
                    $$.ajax({
                        url: "/FastChoose/SetFastBeatItem",
                        type: "post",
                        data: {
                        ...
                        success: function (data) {
                            ...
                            if (data.isStopNum - 0 == 55) {//StopBetItem = 55表示是押停号码
                                ...
                                framework.view("/FastBeat/Index", "BetPanel/FastBeat/Index");
                            }
                        },
                        complete: function () {
