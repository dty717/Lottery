...
define(function (require, exports, module) {
    ...
    var AccountList = function (params) {
        ...
        this.BackBetHistory = function ($data) {
            framework.view("/BetHistory/Index", "BetHistory/index");
        }
            ...
            success: function (json) {
                ...
                $.each(result, function (index, value) {
                    if (value.BetStatus - 0 == 0 || value.BetStatus - 0 == 2) {
                        BetListSum += Number(value.BetAmount);//总金额
                ...
                document.getElementById("BetListSum").innerHTML = BetListSum.toFixed(4) - 0;//总金额 
                document.getElementById("BetListWinLoss").innerHTML = BetListWinLoss.toFixed(4) - 0;//总中奖 
                document.getElementById("BetListBackwater").innerHTML = BetListBackwater.toFixed(4) - 0;//总回水 
                document.getElementById("BetListBackComm").innerHTML = BetListBackComm.toFixed(4) - 0;//总盈亏 
                that.checkeAll(false);
